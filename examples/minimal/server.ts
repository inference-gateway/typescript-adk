...
const AGENT_NAME = process.env['A2A_AGENT_NAME'] ?? 'minimal-agent';
const AGENT_DESCRIPTION =
  process.env['A2A_AGENT_DESCRIPTION'] ??
  'A minimal A2A server that echoes messages';
...
console.log(`minimal-agent listening on http://${HOST}:${PORT}`);
